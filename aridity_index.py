...
for b, aridity in zip(basin_names, historical_avg_AI):
    ax1.scatter(aridity, basin_stats[b][0][0], color='DarkBlue')
    ax1.scatter(aridity, basin_stats[b][0][1], color='Orange')
    ax2.scatter(aridity, basin_stats[b][1][0], color='DarkBlue')
    ax2.scatter(aridity, basin_stats[b][1][1], color='Orange')
    ax3.scatter(aridity, basin_stats[b][2][0], color='DarkBlue')
    ax3.scatter(aridity, basin_stats[b][2][1], color='Orange')
