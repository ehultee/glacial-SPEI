...
Created on Thu Jan 14 17:24:33 2021
...
for m in modelnames:
    for b in basin_names:
        ax1.scatter(m, basin_stats_bymodel[m][b][0][1]-basin_stats_bymodel[m][b][0][0], color='k')
        ax2.scatter(m, basin_stats_bymodel[m][b][1][1]-basin_stats_bymodel[m][b][1][0], color='k')
        ax3.scatter(m, basin_stats_bymodel[m][b][2][1]-basin_stats_bymodel[m][b][2][0], color='k')
ax1.set(ylabel='Diff. in number of droughts 1980-2100')
ax2.set(ylabel='Diff. in drought duration 1980-2100')
ax3.set(ylabel='Diff. in drought severity 1980-2100')
